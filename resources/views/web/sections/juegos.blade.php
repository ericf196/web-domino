        ...
        <div class="tab-content">
            <div class="tab-pane active" id="superpolla" role="tabpanel">
                ...
                <div id="accordion" role="tablist" aria-multiselectable="true"><!-- inicio accordion -->
                    <div class="row">
                        <div class="col">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse-2" aria-expanded="false"
                        ...
                        <div class="col">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse-2a" aria-expanded="false"
                               aria-controls="collapse-2a">
                                <div class="cuadro1">
                                    <img src="img/jugadores.jpg">
                                    <h5>15/12/17</h5>
                                </div>
                    ...
                    <div class="card">
                        <div class="collapse" id="collapse-2">
                            <ul class="nomLigaUl">
                                <li class="nomJugador">
                                    <a data-toggle="collapse" href="#collapse-0" aria-expanded="false"
                                ...
                                <li class="nomJugador">
                                    <a data-toggle="collapse" href="#collapse-0a" aria-expanded="false"
                                       aria-controls="collapse-0a">
                    ...
                    <div class="card">
                        <div class="collapse" id="collapse-2a">
                            <ul class="nomLigaUl">
                                <li class="nomJugador">
                                    <a data-toggle="collapse" href="#collapse-0b" aria-expanded="false"
                                       aria-controls="collapse-0b">
                ...
                <div class="row text-center">
                    @foreach($rankings as $key=>$ranking)
                        <div class="col">
                            <a class="show-hide" data-toggle="collapse" data-parent="#accordion" href="#collapse-{{ $ranking->id }}" aria-expanded="false" aria-controls="collapse-3">
