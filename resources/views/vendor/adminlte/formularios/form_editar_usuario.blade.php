                ...
                <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <button type="button" class="btn btn-xs btn-primary"
                                        onclick="asignar_rol({{ $usuario->id }});">Asignar rol
                                </button>
                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <button type="button" class="btn btn-xs btn-primary"
                                        onclick="quitar_rol({{ $usuario->id }});">Quitar rol
                                </button>
                            </div>
                    ...
                    <form action="{{ url('editar_usuario') }}" method="post" id="f_editar_usuario" class="formentrada">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="state" name="state" value="{{ $usuario->state }}">
                                </div>
                            </div><!-- /.form-group -->
                        </div><!-- /.col -->
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="city" name="city" value="{{ $usuario->city }}">
                                </div>
                            </div><!-- /.form-group -->
                        </div><!-- /.col -->
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="association" name="association" value="{{ $usuario->association }}">
                                </div>
                            </div><!-- /.form-group -->
                        </div><!-- /.col -->
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="federation" name="federation" value="{{ $usuario->federation }}">
                                </div>
                            </div><!-- /.form-group -->
                        </div><!-- /.col -->
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="team" name="team" value="{{ $usuario->team }}">
                                </div>
                            </div><!-- /.form-group -->
                        </div><!-- /.col -->
