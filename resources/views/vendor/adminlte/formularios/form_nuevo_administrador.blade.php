<section>
    <div class="row">
        ...
        <div id="notificacion_resul_admin"></div>

        <form action="{{ url('crear_administrador') }}" method="post" id="f_crear_administrador" class="formentrada">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary  box-gris">
                    ...
                    <div class="box-header with-border my-box-header">
                        <h3 class="box-title"><strong>Nuevo Administrador</strong></h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="federation" name="federation" value="">
                                </div>
                            </div><!-- /.form-group -->
                        </div><!-- /.col -->
                ...
                <div class="box box-primary  box-gris">
                    ...
                    <div class="box-body">
                        ...
                        <div class="box-footer col-xs-12 box-gris ">
                            <button type="submit" class="btn btn-primary">Crear Nuevo Aministrador</button>
                        </div>
                    </div>
                </div><!--box -->
            </div>
