                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="name_league" name="name_league"
                                           value="{{ $leagues->name_league }}" required>
                                </div>
                            </div><!-- /.form-group -->
                        </div><!-- /.col -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="description_league"
                                           name="description_league" value="{{ $leagues->description }}" required>
                                </div>
                            </div><!-- /.form-group -->
                        </div><!-- /.col -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="address_league" name="address_league"
                                           value="{{ $leagues->address }}" required>
                                </div>
                            </div><!-- /.form-group -->
                        </div><!-- /.col -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="name_admin" name="name_admin"
                                           value="{{ $leagues->name_admin }}" required>
                                </div>
                            </div><!-- /.form-group -->
                        </div><!-- /.col -->
