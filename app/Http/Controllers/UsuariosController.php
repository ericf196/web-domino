...
public function form_nuevo_usuario(){
    ...
    $roles=Role::all();
    return view("vendor.adminlte.formularios.form_nuevo_usuario")->with("roles",$roles);
...
public function form_nuevo_rol(){
    ...
    $roles=Role::all();
    return view("vendor.adminlte.formularios.form_nuevo_rol")->with("roles",$roles);
}
...
public function form_nuevo_permiso(){
    ...
    return view("vendor.adminlte.formularios.form_nuevo_permiso")->with("roles",$roles)->with("permisos", $permisos);
}
...
public function crear_usuario(Request $request){
  ...
  if( $validator->fails() ){ 
      return view("vendor.adminlte.mensajes.mensaje_error")->with("msj","...Existen errores...")
  ...
  $usuario->password= bcrypt( $request->input("password") ); 
    ...
    if($usuario->save())
    {
      ...
      return view("vendor.adminlte.mensajes.msj_usuario_creado")->with("msj","Usuario agregado correctamente") ;
    }
    else
    {
...
public function crear_rol(Request $request){
   ...
   $rol->description=$request->input("rol_descripcion") ;
    if($rol->save())
    {
        return view("vendor.adminlte.mensajes.msj_rol_creado")->with("msj","Rol agregado correctamente") ;
    }
    else
    {
        return view("vendor.adminlte.mensajes.mensaje_error")->with("msj","...Hubo un error al agregar ;...") ;
...
public function crear_permiso(Request $request){
   ...
   $permiso->description=$request->input("permiso_descripcion") ;
    if($permiso->save())
    {
        return view("vendor.adminlte.mensajes.msj_permiso_creado")->with("msj","Permiso creado correctamente") ;
    }
    else
    {
        return view("vendor.adminlte.mensajes.mensaje_error")->with("msj","...Hubo un error al agregar ;...") ;
